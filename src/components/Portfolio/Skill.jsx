...
const Skill = () => {
  return (
    <section
      id="skill"
      className="flex items-center justify-center bg-[#111322]"
    >
      <div className="text-center text-white">
        <h1 className="text-5xl text-yellow-300 font-bold pb-3">
          Skill & Tech
        </h1>
        ...
        {/* Các icon công nghệ */}
        <div className="flex flex-wrap justify-center gap-10 mt-8 py-3">
          <FaHtml5 className="text-5xl text-orange-500" />
          <FaCss3Alt className="text-5xl text-blue-500" />
          <FaSass className="text-5xl text-pink-400" />
        ...
        {/* Mô tả công nghệ */}
        <ul className="mt-8 text-lg text-gray-300">
